...
class CommentForm(forms.Form):
    ...
    评论表单 forms里的评论表单
    '''
    author = forms.CharField(widget=forms.TextInput(attrs={"id": "author", "placeholder":"你的名字(必要)","class": "comment_input",
                                                           "required": "required","size": "25", "tabindex": "1"}),
                              max_length=50,error_messages={"required":"username不能为空",})
    email = forms.EmailField(widget=forms.TextInput(attrs={"id":"email","placeholder":"你的邮箱(必要)","type":"email","class": "comment_input",
    ...
    comment = forms.CharField(widget=forms.Textarea(attrs={"id":"comment","class": "message_input",
                                                           ...
                                                           "rows": "5", "placeholder":"在此处书写你的评论内容然后提交","tabindex": "4"}),
